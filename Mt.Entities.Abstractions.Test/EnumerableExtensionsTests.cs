...
namespace Mt.Entities.Abstractions.Test
{
    ...
    public sealed class EnumerableExtensionsTests
    {
        ...
        /// <summary>
        /// Положительные тесты для метода search by id.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="guid">UUDI.</param>
        ...
        /// <summary>
        /// Отрицательные тесты для метода search by id.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="guid">UUDI.</param>
        /// <param name="expected">Ожидаемый результат.</param>
        ...
        /// <summary>
        /// Положительные тесты для метода search by entity.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="guid">UUDI.</param>
        ...
        /// <summary>
        /// Положительные тесты для метода search or default by id.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="guid">UUDI.</param>
        /// <param name="expected">Ожидаемый результат.</param>
        ...
        /// <summary>
        /// Отрицательные тесты для метода search or default by id.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="guid">UUDI.</param>
        /// <param name="expected">Ожидаемый результат.</param>
        ...
        /// <summary>
        /// Положительные тесты для метода search or default by entity.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="guid">UUDI.</param>
        /// <param name="title">Заголовок.</param>
        ...
        /// <summary>
        /// Отрицательные тесты для метода search or default by entity.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="guid">UUDI.</param>
        /// <param name="title">Заголовок.</param>
