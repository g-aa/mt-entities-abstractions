...
namespace Mt.Entities.Abstractions.Test
{
    ...
    public sealed class EnumerableExtensionsTests
    {
        ...
        /// <summary>
        /// Положительные тесты для метода <see cref="EnumerableExtensions.SearchOrCreate{TEntity}(IEnumerable{TEntity}, Guid, Func{TEntity})"/>.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        ...
        /// <summary>
        /// Положительные тесты для метода <see cref="EnumerableExtensions.SearchOrCreate{TEntity}(IEnumerable{TEntity}, TEntity, Func{TEntity})"/>.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        ...
        /// <summary>
        /// Отрицательные тесты для метода <see cref="EnumerableExtensions.SearchOrCreate{TEntity}(IEnumerable{TEntity}, Guid, Func{TEntity})"/>.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="guid">UUID.</param>
        /// <param name="expected">Ожидаемый результат.</param>
        ...
        /// <summary>
        /// Отрицательные тесты для метода <see cref="EnumerableExtensions.SearchOrCreate{TEntity}(IEnumerable{TEntity}, TEntity, Func{TEntity})"/>.
        /// </summary>
        /// <param name="seq">Наименование последовательности.</param>
        /// <param name="title">Заголовок.</param>
        /// <param name="guid">UUID.</param>
